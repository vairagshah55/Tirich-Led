  ...
  return (
    ...
    >
      ...
      <div className={styles.after}>
        <img src={image} alt={labelB} className={styles.img} loading="lazy" decoding="async" />
      ...
      >
        <img src={image} alt={labelA} className={`${styles.img} ${styles.imgBefore}`} loading="lazy" decoding="async" />
